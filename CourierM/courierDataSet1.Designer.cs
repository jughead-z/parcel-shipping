...
namespace CourierM {
    ...
    public partial class courierDataSet1 : global::System.Data.DataSet {
        ...
        public partial class ClientDataTable : global::System.Data.TypedTableBase<ClientRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ClientRow AddClientRow(string IDclient, string RaisonSocial, string Adresse, string Ville, string Tele, string CIN) {
...
namespace CourierM.courierDataSet1TableAdapters {
    ...
    public partial class ClientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Client] WHERE (([IDclient] = @Original_IDclient) AND ((@IsNull_RaisonSocial = 1 AND [RaisonSocial] IS NULL) OR ([RaisonSocial] = @Original_RaisonSocial)) AND ((@IsNull_Adresse = 1 AND [Adresse] IS NULL) OR ([Adresse] = @Original_Adresse)) AND ((@IsNull_Ville = 1 AND [Ville] IS NULL) OR ([Ville] = @Original_Ville)) AND ((@IsNull_Tele = 1 AND [Tele] IS NULL) OR ([Tele] = @Original_Tele)) AND ((@IsNull_CIN = 1 AND [CIN] IS NULL) OR ([CIN] = @Original_CIN)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Client] ([IDclient], [RaisonSocial], [Adresse], [Ville], [Tele" +
                "], [CIN]) VALUES (@IDclient, @RaisonSocial, @Adresse, @Ville, @Tele, @CIN);\r\nSEL" +
                "ECT IDclient, RaisonSocial, Adresse, Ville, Tele, CIN FROM Client WHERE (IDclien" +
                "t = @IDclient)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Client] SET [IDclient] = @IDclient, [RaisonSocial] = @RaisonSocial, [Adresse] = @Adresse, [Ville] = @Ville, [Tele] = @Tele, [CIN] = @CIN WHERE (([IDclient] = @Original_IDclient) AND ((@IsNull_RaisonSocial = 1 AND [RaisonSocial] IS NULL) OR ([RaisonSocial] = @Original_RaisonSocial)) AND ((@IsNull_Adresse = 1 AND [Adresse] IS NULL) OR ([Adresse] = @Original_Adresse)) AND ((@IsNull_Ville = 1 AND [Ville] IS NULL) OR ([Ville] = @Original_Ville)) AND ((@IsNull_Tele = 1 AND [Tele] IS NULL) OR ([Tele] = @Original_Tele)) AND ((@IsNull_CIN = 1 AND [CIN] IS NULL) OR ([CIN] = @Original_CIN)));
SELECT IDclient, RaisonSocial, Adresse, Ville, Tele, CIN FROM Client WHERE (IDclient = @IDclient)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IDclient, RaisonSocial, Adresse, Ville, Tele, CIN FROM dbo.Client";
        ...
        public virtual int Fill(courierDataSet1.ClientDataTable dataTable) {
        ...
        public virtual courierDataSet1.ClientDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            courierDataSet1.ClientDataTable dataTable = new courierDataSet1.ClientDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(courierDataSet1.ClientDataTable dataTable) {
        ...
        public virtual int Delete(string Original_IDclient, string Original_RaisonSocial, string Original_Adresse, string Original_Ville, string Original_Tele, string Original_CIN) {
        ...
        public virtual int Insert(string IDclient, string RaisonSocial, string Adresse, string Ville, string Tele, string CIN) {
            if ((IDclient == null)) {
        ...
        public virtual int Update(string IDclient, string RaisonSocial, string Adresse, string Ville, string Tele, string CIN, string Original_IDclient, string Original_RaisonSocial, string Original_Adresse, string Original_Ville, string Original_Tele, string Original_CIN) {
            if ((IDclient == null)) {
                throw new global::System.ArgumentNullException("IDclient");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string RaisonSocial, string Adresse, string Ville, string Tele, string CIN, string Original_IDclient, string Original_RaisonSocial, string Original_Adresse, string Original_Ville, string Original_Tele, string Original_CIN) {
            return this.Update(Original_IDclient, RaisonSocial, Adresse, Ville, Tele, CIN, Original_IDclient, Original_RaisonSocial, Original_Adresse, Original_Ville, Original_Tele, Original_CIN);
        }
    }
